"""
Django settings for inputquest project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'inputquest.com', 'www.inputquest.com']
...
WSGI_APPLICATION = 'inputquest.wsgi.application'
